...
public class PaperAtlasRuntime implements Listener, AtlasRuntime {
    ...
    private List<Object> runExecutor(final com.mojang.brigadier.context.CommandContext<CommandSourceStack> ctx, Parameter[] parameters) {
    ...
    private CompletableFuture<Suggestions> addSuggestion(final com.mojang.brigadier.context.CommandContext<CommandSourceStack> ctx, final SuggestionsBuilder builder, final Parameter parameter, Argument argAnnotation, Command cmdAnnotation) {
        Entity executor = ctx.getSource().getExecutor();
